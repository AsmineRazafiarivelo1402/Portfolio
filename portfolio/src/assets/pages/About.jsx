...
export default function About() {
  return (
    <>
   <div className="grid grid-col sm:mx-auto md:mx-auto max-w-6xl sm:max-w-6xl px-6 py-10 md:grid md:grid-cols-1 lg:grid-2 gap-6 font-body">
        ...
        <div className="flex flex-col lg:flex-row gap-5">
          <div className="flex flex-col gap-10 max-w-64 min-h-96">
            ...
            <button
              type="button"
              className="w-full sm:w-64 lg:w-full text-white border border-[#f6f6f6] py-2 rounded-lg hover:bg-[#139acf] hover:border-none transition-colors duration-300 flex items-center justify-center gap-2 font-body"
            >
              Read My Resume
            </button>
          </div>
          ...
          <div className="flex flex-col">
            <div className="max-h-64 py-2 my-2 px-1 md:text-[20px] min-w-[10rem] text-[#f6f6f6] text-[15px] hover:border-1 hover:bg-[#474747] hover:rounded-lg transform transition hover:scale-y-125 duration-700 ease-in-out font-body">
            ...
            <div className="flex flex-col gap-3 w-full py-5">
              <div className="text-[#f6f6f6] text-[20px] font-title">
              ...
              <div className="flex flex-col sm:flex-col md:flex-col lg:flex-row gap-5">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  {/* Front-end */}
                  <div className="flex flex-col gap-3">
                    <h1 className="text-[#f6f6f6] text-[15px] font-title">
                      Front-end
                    </h1>
                    ...
                    <div className="flex gap-1 flex-wrap">
                      ...
                      {/* JavaScript */}
                      <div className="relative group cursor-pointer p-1 rounded-lg border border-yellow-500 bg-black/20 flex justify-center items-center">
                        <FontAwesomeIcon
                          icon={faSquareJs}
                      ...
                      {/* React */}
                      <div className="relative group cursor-pointer p-1 rounded-lg border border-sky-400 bg-black/20 flex justify-center items-center">
                        <FontAwesomeIcon
                          icon={faReact}
                      ...
                      {/* HTML */}
                      <div className="relative group cursor-pointer p-1 rounded-lg border border-orange-500 bg-black/20 flex justify-center items-center">
                        <FontAwesomeIcon
                          icon={faHtml5}
                      ...
                      {/* CSS */}
                      <div className="relative group cursor-pointer p-1 rounded-lg border border-blue-500 bg-black/20 flex justify-center items-center">
                        <FontAwesomeIcon
                          icon={faCss3Alt}
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex gap-1 flex-wrap">
                      ...
                      {/* Git */}
                      <div className="relative group cursor-pointer p-1 rounded-lg border border-red-600 bg-black/20 flex justify-center items-center">
                        <FontAwesomeIcon
                          icon={faGit}
                      ...
                      {/* GitHub */}
                      <div className="relative group cursor-pointer p-1 rounded-lg border border-gray-300 bg-black/20 flex justify-center items-center">
                        <FontAwesomeIcon
                          icon={faGithub}
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex gap-1 flex-wrap">
                      ...
                      {/* NodeJS */}
                      <div className="relative group cursor-pointer p-1 rounded-lg border border-green-500 bg-black/20 flex justify-center items-center">
                        <FontAwesomeIcon
                          icon={faNodeJs}
                      ...
                      {/* ExpressJS */}
                      <div className="relative group cursor-pointer p-1 rounded-lg border border-gray-400 bg-black/20 flex justify-center items-center">
                        <FontAwesomeIcon
                          icon={faNodeJs}
                      ...
                      {/* Java */}
                      <div className="relative group cursor-pointer p-1 rounded-lg border border-red-500 bg-black/20 flex justify-center items-center">
                        <FontAwesomeIcon
                          icon={faJava}
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex gap-1 flex-wrap">
                      <div className="relative group cursor-pointer p-1 rounded-lg border border-pink-500 bg-black/20 flex justify-center items-center">
                        <FontAwesomeIcon
                          icon={faFigma}
        ...
        <div className="md:flex md:flex-row gap-y-[10rem] sm:gap-x-10">
          ...
          {/* ================= EXPERIENCE ================= */}
          <div>
            <h1 className="text-xl sm:text-3xl font-bold text-white mb-4 font-title">
              Experience
              <span className="text-[#139acf] text-5xl sm:text-6xl">.</span>
            </h1>
            ...
            <div className="grid grid-3 gap-y-5">
              ...
              <div className="flex gap-4">
                <div className="border h-45 w-[4px] bg-[#858581] rounded-full border-[#858581]"></div>

                <div className="border-bg-red-200 rounded-lg w-64 h-48 bg-red-200 sm:w-96">
                  <div className="flex justify-between px-2 h-1/2 items-center text-[16px] font-title">
                    <h1 className="text-[#1214b6]">Assistant Productory</h1>
                    <p>Oct 2024</p>
                  </div>

                  <div className="flex flex-col px-2 h-1/2 font-body">
                    <p>
                      <a
              ...
              <div className="flex gap-4">
                ...
                <div className="border-bg-red-200 rounded-lg w-64 h-48 bg-red-200 sm:w-96">
                  <div className="flex justify-between px-2 h-1/2 items-center font-title">
              ...
              <div className="flex gap-4">
                ...
                <div className="border-bg-red-200 rounded-lg w-64 h-48 bg-red-200 sm:w-96">
                  ...
                  <div className="flex flex-col px-2 h-1/2 font-body">
                    ...
                    <p>
                      I've been doing my high school at Antsirabe and I've got diploma C
                    </p>
                  </div>
                </div>
              </div>
