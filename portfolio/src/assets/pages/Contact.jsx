...
export default function Contact() {
  return (
    <div className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-1 lg:grid-2 gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        >
          ...
          <div className="relative p-5 grid gap-4">
            <div>
              <h1 className="font-bold text-[20px] sm:text-[22px] text-[#CEE2DC] font-mono flex items-center gap-2">
            ...
            <form className="space-y-4">
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex-1">
                  <label className="block mb-1 font-semibold text-[#CEE2DC]">Name</label>
                  <input
                    type="text"
                ...
                <div className="flex-1">
                  <label className="block mb-1 font-semibold text-[#CEE2DC]">Email</label>
                  <input
              ...
              <div>
                <label className="block mb-1 font-semibold text-[#CEE2DC]">Subject</label>
                <input
              ...
              <div>
                <label className="block mb-1 font-semibold text-[#CEE2DC]">Message</label>
                <textarea
            ...
            <div className="flex justify-center">
              <button className="w-full sm:w-96 lg:w-full text-white border border-[#f6f6f6] py-2 rounded-lg hover:bg-[#139acf] hover:border-none transition-colors duration-300 flex items-center justify-center gap-2">
